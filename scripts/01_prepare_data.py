...
def main() -> int:
    ...
    metadata = {
        ...
        "summary": {
            ...
            "sample_stride": int(args.sample_stride),
            "boundary_purge_applied": bool(subset.metadata["boundary_purge_applied"]),
            "dropped_boundary_sample_count": int(subset.metadata["dropped_boundary_sample_count"]),
            "actual_counts": subset.metadata["actual_counts"],
